...
WmxIoNode::WmxIoNode() : Node("wmx_io_node")
{
  ...
  engineReadySub_ = this->create_subscription<std_msgs::msg::Bool>(
      "wmx/engine/ready", ready_qos, std::bind(&WmxIoNode::onEngineReady, this, _1));

  getInputBitService_ = this->create_service<wmx_ros2_message::srv::GetIoBit>(
      "wmx/io/get_input_bit", std::bind(&WmxIoNode::getInputBit, this, _1, _2));

  getOutputBitService_ = this->create_service<wmx_ros2_message::srv::GetIoBit>(
      "wmx/io/get_output_bit", std::bind(&WmxIoNode::getOutputBit, this, _1, _2));

  getInputBytesService_ = this->create_service<wmx_ros2_message::srv::GetIoBytes>(
      "wmx/io/get_input_bytes", std::bind(&WmxIoNode::getInputBytes, this, _1, _2));

  getOutputBytesService_ = this->create_service<wmx_ros2_message::srv::GetIoBytes>(
      "wmx/io/get_output_bytes", std::bind(&WmxIoNode::getOutputBytes, this, _1, _2));

  setOutputBitService_ = this->create_service<wmx_ros2_message::srv::SetIoBit>(
      "wmx/io/set_output_bit", std::bind(&WmxIoNode::setOutputBit, this, _1, _2));

  setOutputBytesService_ = this->create_service<wmx_ros2_message::srv::SetIoBytes>(
      "wmx/io/set_output_bytes", std::bind(&WmxIoNode::setOutputBytes, this, _1, _2));
...
void WmxIoNode::getInputBit(const std::shared_ptr<wmx_ros2_message::srv::GetIoBit::Request> request,
                            std::shared_ptr<wmx_ros2_message::srv::GetIoBit::Response> response)
{
  ...
  if (err_ != ErrorCode::None) {
    ...
    snprintf(buffer_, sizeof(buffer_), "GetInBitEx failed byte=%d bit=%d. Error=%d (%s)",
  ...
  snprintf(buffer_, sizeof(buffer_), "Input bit %d.%d = %d", request->byte, request->bit, data);
  response->message = buffer_;
}
    ...
    std::shared_ptr<wmx_ros2_message::srv::GetIoBit::Response> response)
{
  ...
  if (err_ != ErrorCode::None) {
    Io::ErrorToString(err_, errString_, sizeof(errString_));
    snprintf(buffer_, sizeof(buffer_), "GetOutBitEx failed byte=%d bit=%d. Error=%d (%s)",
             request->byte, request->bit, err_, errString_);
    RCLCPP_ERROR(this->get_logger(), "%s", buffer_);
    response->success = false;
    response->message = buffer_;
  ...
  response->success = true;
  response->value = static_cast<int32_t>(data);
  snprintf(buffer_, sizeof(buffer_), "Output bit %d.%d = %d", request->byte, request->bit, data);
  response->message = buffer_;
}
    ...
    std::shared_ptr<wmx_ros2_message::srv::GetIoBytes::Response> response)
{
  ...
  if (err_ != ErrorCode::None) {
    Io::ErrorToString(err_, errString_, sizeof(errString_));
    snprintf(buffer_, sizeof(buffer_), "GetInBytesEx failed byte=%d length=%d. Error=%d (%s)",
  ...
  snprintf(buffer_, sizeof(buffer_), "Read %d input bytes from byte %d", request->length,
           request->byte);
  response->message = buffer_;
}
    ...
    std::shared_ptr<wmx_ros2_message::srv::GetIoBytes::Response> response)
{
  ...
  if (err_ != ErrorCode::None) {
    Io::ErrorToString(err_, errString_, sizeof(errString_));
    snprintf(buffer_, sizeof(buffer_), "GetOutBytesEx failed byte=%d length=%d. Error=%d (%s)",
             request->byte, request->length, err_, errString_);
    RCLCPP_ERROR(this->get_logger(), "%s", buffer_);
    response->success = false;
    response->message = buffer_;
  ...
  response->success = true;
  response->data.assign(data.begin(), data.end());
  snprintf(buffer_, sizeof(buffer_), "Read %d output bytes from byte %d", request->length,
           request->byte);
  response->message = buffer_;
}
    ...
    std::shared_ptr<wmx_ros2_message::srv::SetIoBit::Response> response)
{
  ...
  if (err_ != ErrorCode::None) {
    Io::ErrorToString(err_, errString_, sizeof(errString_));
    snprintf(buffer_, sizeof(buffer_), "SetOutBitEx failed byte=%d bit=%d value=%d. Error=%d (%s)",
  ...
  snprintf(buffer_, sizeof(buffer_), "Set output bit %d.%d = %d", request->byte, request->bit,
           request->value);
    ...
    std::shared_ptr<wmx_ros2_message::srv::SetIoBytes::Response> response)
{
  ...
  if (err_ != ErrorCode::None) {
    Io::ErrorToString(err_, errString_, sizeof(errString_));
    snprintf(buffer_, sizeof(buffer_), "SetOutBytesEx failed byte=%d length=%d. Error=%d (%s)",
  ...
  snprintf(buffer_, sizeof(buffer_), "Set %d output bytes from byte %d", dataLen, request->byte);
  RCLCPP_INFO(this->get_logger(), "%s", buffer_);
  response->success = true;
  response->message = buffer_;
}
