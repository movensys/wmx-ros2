...
DiffDriveController::DiffDriveController() : Node("diff_drive_controller"), wmx3LibCm_(&wmx3Lib_) {  
    RCLCPP_INFO(this->get_logger(), "start diff_drive_controller");
    ...
    RCLCPP_INFO(this->get_logger(), "diff_drive_controller is ready");
...
DiffDriveController::~DiffDriveController(){
    ...
    RCLCPP_INFO(this->get_logger(), "diff_drive_controller is stopped");
}
...
void DiffDriveController::setRosParameter(){
    ...
    this->declare_parameter<std::string>("encoder_vel_topic", "/diff_drive/no_param");
...
void DiffDriveController::setWmxParam(char* path){
...
void DiffDriveController::startEngine(){
    ...
    wmx3Lib_.SetDeviceName("DiffDriveController");
    if (err_ != ErrorCode::None) {
        wmx3Lib_.ErrorToString(err_, errString_, sizeof(errString_));
