...
ros2 service call /wmx/params/load wmx_ros2_message/srv/LoadWmxParams \
  "{file_path: '/home/$USER/movensys_ws/install/wmx_ros2_package/share/wmx_ros2_package/config/cr3a_wmx_parameters.xml'}"
...
# Diffbot
ros2 service call /wmx/params/load wmx_ros2_message/srv/LoadWmxParams \
  "{file_path: '/home/$USER/movensys_ws/install/wmx_ros2_package/share/wmx_ros2_package/config/diffbot_wmx_parameters.xml'}"
```
