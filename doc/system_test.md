...
|------|----------|----------------|
| test_message_interfaces | 28 | All 3 msg types (AxesStatus, AxesPose, AxesVelocity) and 13 srv types: field existence, types, population, renames (in_pos->motion_complete, denumerator->denominator) |
